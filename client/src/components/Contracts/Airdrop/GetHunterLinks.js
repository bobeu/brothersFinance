        ...
        const s = new Promise(
            async (resolve, reject) => {
                try{
                    ...
                    const result = await web3.contract_instance.methods.getHunterLinks(props.targ, props.id).send({from: account});
                    resolve(result);
