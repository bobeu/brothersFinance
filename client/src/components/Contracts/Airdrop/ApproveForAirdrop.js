...
function ApproveForAirdrop(props) {
        ...
        const s = new Promise(
            async (resolve, reject) => {
                try{
                    ...
                    const result = await web3.contract_instance.methods.approveForAirdrop(props.targ).send({from: account});
                    resolve(result);
...
export default ApproveForAirdrop;
