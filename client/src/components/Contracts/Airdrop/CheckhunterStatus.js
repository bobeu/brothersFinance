...
function CheckhunterStatus(props) {
        ...
        const s = new Promise(
            async (resolve, reject) => {
                try{
                    ...
                    const result = await web3.contract_instance.methods.checkhunterStatus(props.id).send({from: account});
                    resolve(result);
...
export default CheckhunterStatus;
