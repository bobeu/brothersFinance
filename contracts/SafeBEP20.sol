...
contract SafeBEP20 is Ownable, IBEP20, IERC20Metadata {
    ...
    modifier isNotsuspended() {
        require(!suspension[_msgSender()], 'Restricted');
        _;
    }
     ...
     * - `spender` cannot be the zero address.
     */
    function increaseAllowance(address spender, uint256 addedValue) public isNotsuspended returns (bool) {
     ...
     * `subtractedValue`.
     */
    function decreaseAllowance(address spender, uint256 subtractedValue) public isNotsuspended returns (bool) {
